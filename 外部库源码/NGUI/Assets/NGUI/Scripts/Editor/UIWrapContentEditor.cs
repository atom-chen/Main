...
public class UIWrapContentEditor : Editor
{
	public override void OnInspectorGUI ()
	{
		...
		NGUIEditorTools.DrawProperty("Item Width", serializedObject, "itemSize", GUILayout.Width(130f));
		GUILayout.Label("pixels");
		GUILayout.EndHorizontal();

        GUILayout.BeginHorizontal();
        NGUIEditorTools.DrawProperty("Item Height", serializedObject, "itemHeight", GUILayout.Width(130f));
        GUILayout.Label("pixels");
        GUILayout.EndHorizontal();

        GUILayout.BeginHorizontal();
        NGUIEditorTools.DrawProperty("Column", serializedObject, "column", GUILayout.Width(130f));
        GUILayout.EndHorizontal();
