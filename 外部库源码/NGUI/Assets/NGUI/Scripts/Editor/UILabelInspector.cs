	...
	protected override bool ShouldDrawProperties ()
	{
		...
		EditorGUI.BeginDisabledGroup(!isValid);
		{
			...
			else
			{
                ...
                //SerializedProperty spUseDic = serializedObject.FindProperty("mUseDicTable");
                SerializedProperty spUseDic = NGUIEditorTools.DrawProperty("UseDic", serializedObject, "mUseDicTable",
            GUILayout.Width(95f));
                ...
                NGUIEditorTools.DrawProperty("支持字典通配符", serializedObject, "mSupportDictSymbol",
GUILayout.Width(95f));
                NGUIEditorTools.DrawProperty("固定位置", serializedObject, "m_bFixPos",
GUILayout.Width(95f));
                SerializedProperty spUseSymbol = NGUIEditorTools.DrawProperty("UseSymbol", serializedObject, "mUseSymbol",
            GUILayout.Width(95f));
                if (spUseSymbol.boolValue)
                {
                    SerializedProperty spSymbolAtlas = NGUIEditorTools.DrawProperty("SymbolAtlas", serializedObject, "mSymbolAtlas", GUILayout.Width(200f));
                }

            //    SerializedProperty spPraseLink = NGUIEditorTools.DrawProperty("PraseLink", serializedObject, "mPraseLink",
            //GUILayout.Width(95f));
            //    if (spPraseLink.boolValue)
            //    {
            //        SerializedProperty spLinkItem = NGUIEditorTools.DrawProperty("LinkItem", serializedObject, "mLinkItem", GUILayout.Width(200f));
            //    }
            }
            ...
            SerializedProperty spForceColor = NGUIEditorTools.DrawProperty("Force Color", serializedObject, "mForceColor", GUILayout.Width(95f));
