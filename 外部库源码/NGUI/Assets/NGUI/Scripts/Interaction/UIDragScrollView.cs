...
public class UIDragScrollView : MonoBehaviour
{
	...
	void OnPress (bool pressed)
	{
	    ...
	    if (scrollView && scrollView.bindScrollView != null)
	    {
            UIDragScrollView child = scrollView.bindScrollView.GetComponentInChildren<UIDragScrollView>();
            if (child != null && child.GetComponent<UIDragScrollView>() != null)
            {
                child.ForceOnPress(pressed);
            }
        }
	}

    public void ForceOnPress(bool pressed)
    {
        if (mAutoFind && mScroll != scrollView)
        {
            mScroll = scrollView;
	...
	void OnDrag (Vector2 delta)
	{
        ...
        if (scrollView && scrollView.bindScrollView != null)
        {
            ...
            if (child != null && child.GetComponent<UIDragScrollView>() != null)
            {
                child.ForceOnDrag(delta);
            }
        }
    }

    void ForceOnDrag(Vector2 delta)
    {
        if (scrollView && NGUITools.GetActive(this))
            scrollView.Drag();
    }
    ...
    void OnScroll (float delta)
	{
        ...
        if (scrollView && scrollView.bindScrollView != null)
        {
            ...
            if (child != null && child.GetComponent<UIDragScrollView>() != null)
            {
                child.ForceOnScroll(delta);
            }
        }
    }

    void ForceOnScroll(float delta)
    {
        if (scrollView && NGUITools.GetActive(this))
            scrollView.Scroll(delta);
    }
    ...
    public void OnPan (Vector2 delta)
	{
        ...
        if (scrollView && scrollView.bindScrollView != null)
        {
            ...
            if (child != null && child.GetComponent<UIDragScrollView>() != null)
            {
                child.ForceOnPan(delta);
            }
        }
    }

    public void ForceOnPan(Vector2 delta)
    {
        if (scrollView && NGUITools.GetActive(this))
            scrollView.OnPan(delta);
    }
