...
public:
	void SetAmbientMaterialMaterial(float r, float g, float b, float a = 1);
	void SetDiffuseMaterialMaterial(float r, float g, float b, float a = 1);
	void SetSpecularMaterialMaterial(float r, float g, float b, float a = 1);

	void SetTexture2D(const char* path);
