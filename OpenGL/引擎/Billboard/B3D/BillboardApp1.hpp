...
class   BillboardApp1 :public CELLWinApp
{
public:
    ...
    */
    virtual void    render(const CELLFrameEvent& evt)
    {
        ...
        
        {
            ...
            {
                glUniform1i(_shader._texture,0);
                _billboard._pos     =   float3(5,0,5);
                _billboard._size    =   float2(10,10);
                //! 绘制地面
                glUniformMatrix4fv(_shader._MVP, 1, false, MVP.data());
                _billboard.render(evt,_camera3rd,_shader);
