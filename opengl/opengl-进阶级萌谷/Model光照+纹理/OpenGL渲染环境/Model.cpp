...
bool Model::Init(const char* path, const char* vertexShader, const char* fragmentShader)
{
	...
	this->SetAmbientMaterialMaterial(m_AmbientMaterial[0], m_AmbientMaterial[1], m_AmbientMaterial[2], m_AmbientMaterial[3]);
	this->SetDiffuseMaterialMaterial(m_DiffuseMaterial[0], m_DiffuseMaterial[1], m_DiffuseMaterial[2], m_DiffuseMaterial[3]);
	this->SetSpecularMaterialMaterial(m_SpecularMaterial[0], m_SpecularMaterial[1], m_SpecularMaterial[2], m_SpecularMaterial[3]);
...
void Model::SetAmbientMaterialMaterial(float r, float g, float b, float a)
{
...
void Model::SetDiffuseMaterialMaterial(float r, float g, float b, float a)
{
...
void Model::SetSpecularMaterialMaterial(float r, float g, float b, float a)
{
