...
public class FingerGestures : MonoBehaviour
{
    ...
    public void InstallInputProvider( FGInputProvider inputProviderPrefab )
    {
        ...
        {
            //LogModule.ErrorLog( "Invalid InputProvider (null)" );
            return;
        }
    ...
    void CheckInit()
    {
        ...
        {
            //LogModule.WarningLog( "There is already an instance of FingerGestures created (" + instance.name + "). Destroying new one." );
