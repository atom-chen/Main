...
public class UISpriteAnimationInspector : Editor
{
	...
	public override void OnInspectorGUI ()
	{
	    ...
	    NGUIEditorTools.DrawProperty("Auto Play", serializedObject, "autoPlay");
        NGUIEditorTools.DrawProperty("Auto Reset", serializedObject, "autoReset");
        NGUIEditorTools.DrawProperty("Start Delay", serializedObject, "startDelay");
