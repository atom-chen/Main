...
public class UIInput : MonoBehaviour
{
    ...
    public OnValidate onValidate = null;// GameInputFilter.OnInputValidator;
	...
	public string Validate (string val)
	{
        ...
        if (utf8length)
        {
            if (characterLimit > 0 && System.Text.Encoding.UTF8.GetBytes(sb.ToString()).Length > characterLimit)
            {
                for (int i = 1; i <= val.Length; i++)
                {
                    if (System.Text.Encoding.UTF8.GetBytes(sb.ToString(0, i)).Length > characterLimit)
                    {
...
#if MOBILE
        //if (ChatInfoController.Instance() != null && this == ChatInfoController.Instance().m_ChatInput)
        //{
        //    ChatInfoController.Instance().OnInputDeselect();
        //}
        //if (LoudSpeakerWindow.Instance() != null && this == LoudSpeakerWindow.Instance().m_LoudSpeakerInput)
        //{
        //    LoudSpeakerWindow.Instance().OnInputDeselect();
        //}
        //if (RelationController.Instance() != null && this == RelationController.Instance().GetFrienChatInput())
        //{
        //    RelationController.Instance().OnInputDeselect();
        //}
        //if (RelationController.Instance() != null && this == RelationController.Instance().GetPersonalSignInput())
        //{
        //    RelationController.Instance().OnSignInputDeselect();
        //}
        //if (RelationController.Instance() != null && this == RelationController.Instance().GetSearchInput())
        //{
        //    RelationController.Instance().OnSearchInputDeselect();
        //}
        //if (ChatRoomChatController.Instance() != null && this == ChatRoomChatController.Instance().m_ChatInput)
        //{
        //    ChatRoomChatController.Instance().OnInputDeselect();
        //}
        //if (AddFriendMsgEditLogic.Instance() != null && this == AddFriendMsgEditLogic.Instance().m_AddFrnMsgInput)
        //{
        //    AddFriendMsgEditLogic.Instance().PopDownAddFrdMsgPanel();
        //}
#endif

        if (delOnDeselect != null)
        {
            delOnDeselect();
        }
    }
	...
	protected virtual void Insert (string text)
	{
		...
		for (int i = 0, imax = text.Length; i < imax; ++i)
		{
            ...
            if (utf8length)
            {
                if (characterLimit > 0 && System.Text.Encoding.UTF8.GetBytes(sb + c.ToString() + right).Length > characterLimit) break;
            }
            else
            {
    ...
    public delegate void OndelSelect();
    public OndelSelect delOnSelect = null;

    public delegate void OndelDeselect();
    public OndelDeselect delOnDeselect = null;
