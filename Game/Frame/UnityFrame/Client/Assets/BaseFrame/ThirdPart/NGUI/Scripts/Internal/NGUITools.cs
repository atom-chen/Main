...
static public class NGUITools
{
	...
	static public AudioSource PlaySound (AudioClip clip, float volume, float pitch)
	{
		...
		if (clip != null && volume > 0.01f)
		{
			...
			{
				if (true ) //null != GameManager.SoundManager && null != GameManager.SoundManager.m_UISoundSource)
				{
...
//    {
//#if UNITY_FLASH
//        LogModule.ErrorLog("WWW is not yet implemented in Flash");
//        return null;
//#else
//        WWW www = null;
//        try { www = new WWW(url); }
//        catch (System.Exception ex) { LogModule.ErrorLog(ex.Message); }
//        return www;
//#endif
//    }
...
//        catch (System.Exception ex) { LogModule.ErrorLog(ex != null ? ex.Message : "<null>"); }
//        return www;
//#endif
//    }
