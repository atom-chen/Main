...
public class QuartzTool
{
    ...
    public static int QuartzSort_Star(Quartz left, Quartz right)
    {
    ...
    public static int QuartzSort_Strengthen(Quartz left, Quartz right)
    {
        if (left == null || false == left.IsValid())
        {
            return 1;
    ...
    public static int QuartzSort_NewGet(Quartz left, Quartz right)
    {
        if (left == null || false == left.IsValid())
        {
            return 1;
    ...
    {
        return Utils.GetColorIcon(GetQuartzStarColor(star));
    }
    ...
    public static string GetQuartzStarName(int star)
    {
        ...
        {
            case (int)COLOR.WHITE:
                return StrDictionary.GetDicByID(5567);
            case (int)COLOR.GREEN:
                return StrDictionary.GetDicByID(5568);
            case (int)COLOR.BLUE:
                return StrDictionary.GetDicByID(5569);
            case (int)COLOR.PURPLE:
                return StrDictionary.GetDicByID(5570);
            case (int)COLOR.ORANGE:
                return StrDictionary.GetDicByID(5571);
            case (int)COLOR.RED:
                return StrDictionary.GetDicByID(6867);
            default:
                return "";
        }
    }
