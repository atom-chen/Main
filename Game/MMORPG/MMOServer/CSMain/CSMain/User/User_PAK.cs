...
public partial class User
{
    ...
    public void SendPak(GC_PAK_BASE pak, Photon.SocketServer.SendParameters para)
    {
        m_Connect.SendOperationResponse(pak._Response, para);
    }

    public void SendPak(GC_PAK_BASE pak)
    {
        m_Connect.SendOperationResponse(pak._Response, new SendParameters());
    }
