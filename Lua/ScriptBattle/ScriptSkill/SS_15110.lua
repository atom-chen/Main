...
local i_Disablepassive = i_mk(sc.CommonBuffs.Disablepassive)   --引用通用封印
      i_Disablepassive.Duration = 2    
...
local sk_main = sk_mk{
    ...
    H_1 = h_mk{
        ...
        I_1 ={
            IsChanceRefix = 1,
            Impact =  i_Disablepassive,                      --fengying2回合
        },
        I_2 = {
            Impact = i_damage,
        },
