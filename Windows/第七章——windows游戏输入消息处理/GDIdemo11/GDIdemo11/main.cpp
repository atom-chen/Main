...
//位图句柄
HBITMAP g_SwordMan = NULL, g_Bg = NULL, g_SwordBlade=NULL;
//光标位置
unsigned g_MouseX = 0, g_MouseY = 0;
//人物位置
unsigned g_PlayerX=0, g_PlayerY=0;
//滚动背景所要剪裁的区域宽度
unsigned g_BGOffset = 0;
//玩家现有子弹数目
unsigned g_BulletNum = 0;
//存储玩家发出的子弹
vector<SwordBullets> g_Bullets;
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
		...
		break;
	case WM_LBUTTONDOWN:                   //处理按下鼠标左键的信息
